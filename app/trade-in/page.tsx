          ...
          <div style={{ background: "#f8fafc", borderRadius: 28, padding: 40 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              <div>
                ...
                <input type="text" placeholder="Your name" style={{ width: "100%", padding: "14px 20px", borderRadius: 100, border: "1px solid #ebf0f5", fontSize: 14, outline: "none" }} />
              </div>
              <div>
                <label style={{ fontWeight: 700, fontSize: 14, display: "block", marginBottom: 8 }}>Vehicle Make & Model</label>
                <input type="text" placeholder="e.g. Toyota Camry" style={{ width: "100%", padding: "14px 20px", borderRadius: 100, border: "1px solid #ebf0f5", fontSize: 14, outline: "none" }} />
              </div>
              <div>
                <label style={{ fontWeight: 700, fontSize: 14, display: "block", marginBottom: 8 }}>Year</label>
                <input type="text" placeholder="e.g. 2019" style={{ width: "100%", padding: "14px 20px", borderRadius: 100, border: "1px solid #ebf0f5", fontSize: 14, outline: "none" }} />
              </div>
              <div>
                <label style={{ fontWeight: 700, fontSize: 14, display: "block", marginBottom: 8 }}>Mileage</label>
                <input type="text" placeholder="e.g. 45,000" style={{ width: "100%", padding: "14px 20px", borderRadius: 100, border: "1px solid #ebf0f5", fontSize: 14, outline: "none" }} />
              </div>
              <div>
                <label style={{ fontWeight: 700, fontSize: 14, display: "block", marginBottom: 8 }}>Condition</label>
                <select style={{ width: "100%", padding: "14px 20px", borderRadius: 100, border: "1px solid #ebf0f5", fontSize: 14, outline: "none", background: "#fff" }}>
              ...
              <button style={{ background: "#000", color: "#fff", borderRadius: 100, padding: "16px 24px", fontWeight: 700, fontSize: 14, border: "none", cursor: "pointer", marginTop: 8 }}>Get My Trade-In Value</button>
            </div>
          </div>
        </div>
      </main>
