          ...
          <div>
            <div style={{ background: "#f8fafc", borderRadius: 28, padding: 40, marginBottom: 24 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                ...
                <div>
                  <label style={{ fontWeight: 700, fontSize: 14, display: "block", marginBottom: 8 }}>Email</label>
                  <input type="email" placeholder="your@email.com" style={{ width: "100%", padding: "14px 20px", borderRadius: 100, border: "1px solid #ebf0f5", fontSize: 14, outline: "none" }} />
                </div>
                <div>
                  <label style={{ fontWeight: 700, fontSize: 14, display: "block", marginBottom: 8 }}>Phone</label>
                  <input type="tel" placeholder="Your phone number" style={{ width: "100%", padding: "14px 20px", borderRadius: 100, border: "1px solid #ebf0f5", fontSize: 14, outline: "none" }} />
                </div>
                <div>
                  <label style={{ fontWeight: 700, fontSize: 14, display: "block", marginBottom: 8 }}>Message</label>
                  <textarea placeholder="How can we help you?" rows={5} style={{ width: "100%", padding: "14px 20px", borderRadius: 24, border: "1px solid #ebf0f5", fontSize: 14, outline: "none", resize: "none" }} />
                </div>
                <button style={{ background: "#000", color: "#fff", borderRadius: 100, padding: "16px 24px", fontWeight: 700, fontSize: 14, border: "none", cursor: "pointer" }}>Send Message</button>
              </div>
            </div>
          </div>
